...
{
    tti_real dp1, dq1, dr1, dp2, dq2, dr2;
    tti_real v1[3], v2[3];
    tti_real N1[3], N2[3];
...
int coplanar_tri_tri3d(tti_real p1[3], tti_real q1[3], tti_real r1[3],
    tti_real p2[3], tti_real q2[3], tti_real r2[3],
    tti_real normal_1[3], tti_real normal_2[3]){
  
    tti_real P1[2],Q1[2],R1[2];
    tti_real P2[2],Q2[2],R2[2];

    tti_real n_x, n_y, n_z;
...
{
    tti_real dp1, dq1, dr1, dp2, dq2, dr2;
    tti_real v1[3], v2[3], v[3];
    tti_real N1[3], N2[3], N[3];
    tti_real alpha;
